  ...
  return (
    <div id="home" className="pb-20 pt-36">
      <div>
        ...
        />
        <Spotlight
          className="hidden sm:block top-10 left-full h-[80vh] w-[50vw]"
          fill="purple"
        />
        <Spotlight
          className="hidden sm:block top-28 left-80 h-[80vh] w-[50vw]"
          fill="blue"
        />
      </div>
      ...
      <div className="flex justify-center relative my-20 z-10">
        <div className="max-w-[89vw] md:max-w-2xl lg:max-w-[60vw] flex flex-col items-center justify-center">
          <h2 className="uppercase tracking-widest text-xs text-center text-blue-100 max-w-100">
            Aspiring Software Engineer with a passion for building innovative
            solutions.
          </h2>
          <TextGenerateEffect
            ...
            words="Nagaraj Sita"
          />
          <p className="text-center md:tracking-wider mb-6 text-lg md:text-2xl lg:text-3xl">
            Passionate Learner:{" "}
            <span className="text-purple">Continuously Evolving</span> to
            Redefine Excellence
          </p>{" "}
          <a href="#projects">
            <MagicButton
